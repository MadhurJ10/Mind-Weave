...
const Login = () => {
    ...
    useEffect(() => {
        // Read query params when redirected back
    ...
    return (
        <div className="h-screen flex">
            ...
            {/* Right Side */}
            <div className="w-1/2 bg-[#0f0f0f] flex flex-col justify-center items-center p-10">
                <div className="w-full max-w-md bg-black p-8 rounded-xl shadow-lg border border-red-500/20">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="text-right mb-6">
                            <a href="#" className="text-sm text-red-400 hover:text-red-500 hover:underline">
                                Reset password
                            </a>
                        </div>
