        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-8 py-16 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <form className="mt-6 flex max-w-md gap-x-4">
              ...
              <button
                type="submit"
                className="flex-none rounded-md bg-[#FF4533] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#FF2410] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FF4533] transition-colors"
              >
                Notify Me
              </button>
            </form>
